...
## Corpus Check
- 57 files · ~14,342 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 384 nodes · 902 edges · 16 communities detected
- Extraction: 56% EXTRACTED · 44% INFERRED · 0% AMBIGUOUS · INFERRED: 393 edges (avg confidence: 0.64)
...
Cohesion: 0.1
Nodes (37): ABC, BanditAnnotator, Bandit security annotator., AnnotatorResult, BaseAnnotator, Base interface for graph annotators., Check that the underlying tool is installed and runnable., BaseAnnotator (+29 more)
...
Cohesion: 0.12
Nodes (36): _aliased_import_parts(), build_graph(), _call_name(), _class_base_names(), _class_definition_nodes(), _collect_python_files(), Definition, _docstring() (+28 more)
...
Cohesion: 0.15
Nodes (20): _add_edge(), Build a NetworkX code graph from Python source files.  The builder intentionally, _add_edge(), _candidate_names(), _dedupe(), _matches_suffix(), Name-based cross-file graph resolution.  This resolver is deliberately conservat, resolve_calls() (+12 more)
...
Cohesion: 0.2
Nodes (8): PipelineLogger, run_pipeline(), _stdlib_logger(), FailingAnnotator, GoodAnnotator, test_run_pipeline_times_successes_and_isolates_failures(), UnavailableAnnotator, test_test_linkage_adds_static_tested_by_edges()
...
- **Why does `build_graph()` connect `Community 3` to `Community 1`, `Community 2`, `Community 5`, `Community 6`, `Community 8`?**
  _High betweenness centrality (0.144) - this node is a cross-community bridge._
- **Why does `RunLogger` connect `Community 2` to `Community 8`, `Community 1`, `Community 4`, `Community 7`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `AnnotatorResult` connect `Community 1` to `Community 8`, `Community 2`, `Community 4`, `Community 5`?**
